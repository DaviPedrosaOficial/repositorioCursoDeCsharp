    ...
    class Aula6_Cap3
    {
        static void _Aula6_Cap3(string[] arg)
        {
            /* ------ O que são properties (propriedades) ------
             ...
             As propriedades são funcionalidades que auxiliam na implementação de métodos a nossas classe. Tornando mais 
            ...
            atributos, e ao fazermos o mesmo, poderemos chamar os métodos get & set para os mesmos, sem precisarmos 
            desenvolver 2 funções para nosso projeto. (Veja a execução na classe Lapis)

...
namespace CursoDeCsharp{
    ...
    class Aula9_Cap5{
        ...
        static void _Aula9_Cap5(string [] arg){
            ...
            Console.Write("\r\n---- myDate3 ---- : ");
            Console.WriteLine(myDate3);
            /* Já no DateTime myDate3, como seu tipo é Unspecified (não especificado), temos a conversão nas 2 funções, tanto quando
            passamos o mesmo para local, como quando passamos para Utc. Isso, ocorre justamente por não especificarmos seu tipo, sendo
            assim, ao chamarmos o comando o nosso compilador ira executar o mesmo em ambas as ocasiões. */
